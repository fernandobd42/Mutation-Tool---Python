            ...
            if (operators['Operators'] != []):
                for op in operators['Operators']:
                    ...
                    if lines != []:
                        ...
                        logging.error('Dont have any operators in the program')
            else:
                logging.debug("The key name 'Operators' of json don't have no one operator")
        else:
            logging.debug("The key name of json is incorrect, please set the name 'Operators'")
